...
const setCustomers = (Customer) => {
  return Promise.all([
    Customer.create({
      ...
      gender: "male",
      age: 70,
      email: "olivier.macdonald@example.com",
    }),
    Customer.create({
      firstname: "Dave",
      lastname: "Fisher",
    ...
    Customer.create({
      ...
      gender: "female",
      age: 30,
      email: "lillie.franklin@example.com",
    }),
    Customer.create({
      firstname: "Leroy",
      lastname: "Ramirez",
      gender: "male",
      age: 39,
      email: "leroy.ramirez@example.com",
    }),
    Customer.create({
      firstname: "Victoria",
      lastname: "Rocha",
      gender: "female",
      age: 52,
      email: "victoria.rocha@example.com",
    }),
    Customer.create({
      firstname: "Lucas",
    ...
    Customer.create({
      ...
      gender: "male",
      age: 21,
      email: "gabriel.nieto@example.com",
    }),
    Customer.create({
      firstname: "Ellen",
      lastname: "Arola",
    ...
    Customer.create({
      ...
      gender: "male",
      age: 34,
      email: "augustin.dasilva@example.com",
    }),
    Customer.create({
      firstname: "Giray",
      lastname: "Balci",
